        ...
        <div className="grid grid-rows-4 grid-cols-4 w-auto h-auto gap-4">
          <div className="col-span-4 row-span-2 ">
            ...
            <h3 className="font-bold text-lg mt-5">
              Games Pokemon on Nintendo Switch
            </h3>
            <p className="mb-5">
              Pokemon games on the Switch have the best and best features where
              players are pampered with various scenes and images that are very
              modern, but don't lose the feel of Pokemon.
            </p>
          </div>
          <div className="col-start-1 row-span-2 col-span-2">
            <img
              src={poke_game_switch}
              alt="game play"
