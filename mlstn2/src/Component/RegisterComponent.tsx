    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-96 border border-red-500 border-4 rounded-xl bg-white">
        ...
        <div>
          ...
          <div className="bg-red-500 p-1 flex items-center justify-center gap-10">
            <img src={pika} alt="Pokemon Logo" className="w-40"/>
            <a onClick={() => navigate("/newRegister")} className="text-xl mr-5 text-white  hover:underline font-medium">
                <p>Register Here</p>
            </a>
          </div>
        </div>
